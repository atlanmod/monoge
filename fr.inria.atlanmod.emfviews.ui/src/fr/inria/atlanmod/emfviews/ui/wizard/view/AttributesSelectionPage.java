...
public class AttributesSelectionPage extends WizardPage {
	...
	public void setTreeContents() {
		CreateViewtypeScreen page = (CreateViewtypeScreen) getWizard().getPage(
				Messages.getString("VirtualMetamodelFileScreen.Page.Name"));
		...
		checkboxTreeViewer.setInput(virtualResourceSet.getPackageRegistry()
				.values());
	}
