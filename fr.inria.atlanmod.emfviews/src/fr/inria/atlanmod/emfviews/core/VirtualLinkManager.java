...
public class VirtualLinkManager {
	...
	public VirtualLinkManager(String correspondenceModelURI, View vModel)
		...
		System.out.println("core virtuallinkmanager");
	...
	public void initialize() {
		System.out.println("core virtuallinkmanager initialize");
	...
	public void setVirtualLink(EObject concreteElement,
		...
		System.out.println("core virtuallinkmanager setvirtuallink");
		virtualLinks.put(concreteElement, virtualElement);
	}

	public Map<EObject, VirtualElement> getVirtualLinks() {
		System.out.println("core virtuallinkmanager getvirtuallinks");
		return virtualLinks;
	}
	...
	public EObject getVirtualElement(EObject e) {
		System.out.println("core virtuallinkmanager getvirtualelement");
