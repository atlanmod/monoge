...
public interface ExtensionPackage extends EPackage
{
   ...
   * @ordered
   */
  int ADD_PROPERTY_FEATURE_COUNT = MODIFY_OPERATOR_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the attribute '{@link monoge.dsl.extension.AddProperty#getType <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
