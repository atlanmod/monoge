 ...
 * <ul>
 * <li>
 * {@link fr.inria.atlanmod.emfviews.virtualLinks.impl.VirtualLinksImpl#getVirtualLinks
 * <em>Virtual Links</em>}</li>
 * <li>
 * {@link fr.inria.atlanmod.emfviews.virtualLinks.impl.VirtualLinksImpl#getLinkedElements
 ...
 * @generated
 */
public class VirtualLinksImpl extends MinimalEObjectImpl.Container implements
		VirtualLinks {
	/**
	 * The cached value of the '{@link #getVirtualLinks()
	 * <em>Virtual Links</em>}' containment reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getVirtualLinks()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLinkedElements()
	 * <em>Linked Elements</em>}' containment reference list. <!--
	...
	public EList<VirtualLink> getVirtualLinks() {
		if (virtualLinks == null) {
			virtualLinks = new EObjectContainmentEList<VirtualLink>(
					VirtualLink.class, this,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case VirtualLinksPackage.VIRTUAL_LINKS__VIRTUAL_LINKS:
			return ((InternalEList<?>) getVirtualLinks()).basicRemove(otherEnd,
					msgs);
		case VirtualLinksPackage.VIRTUAL_LINKS__LINKED_ELEMENTS:
			return ((InternalEList<?>) getLinkedElements()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case VirtualLinksPackage.VIRTUAL_LINKS__VIRTUAL_LINKS:
			...
			getVirtualLinks().addAll(
					(Collection<? extends VirtualLink>) newValue);
			return;
		case VirtualLinksPackage.VIRTUAL_LINKS__LINKED_ELEMENTS:
			getLinkedElements().clear();
			getLinkedElements().addAll(
